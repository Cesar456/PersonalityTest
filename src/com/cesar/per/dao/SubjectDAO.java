 ...
 * 
 * @see com.cesar.per.bean.Subject
...
public class SubjectDAO extends HibernateDaoSupport {
	...
	public static final String IS_AGAINST = "isAgainst";
	...
	public List findByDimensionality(Object dimensionality) {
		return findByProperty(DIMENSIONALITY, dimensionality);
	}

	public List findByIsAgainst(Object isAgainst) {
		return findByProperty(IS_AGAINST, isAgainst);
	}
